<div id="middle" class="container">
	<div class="row">
		<div class="bs-docs-section">
			<div class="row"><div class="col-lg-12 text-center"><h1>Pendaftaran Instansi</h1></div></div>
			<div class="row">
				<div class="col-lg-12">
					<div class="well">
						...
						'htmlOptions' => array("class"=>"form-horizontal",'role' => 'form'),
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<?php echo $form->textField($user,'username',array('class'=>'form-control','required'=>'required')); ?>
									</div>
								</div>
								<div class="form-group">
									<?php echo $form->labelEx($user,'password',array('class'=>'col-lg-2 control-label')); ?>
									<div class="col-lg-10">
										<?php echo $form->passwordField($user,'password',array('class'=>'form-control','required'=>'required')); ?>
									</div>
								</div> 
								<div class="form-group">
									<label for="konfirmasi" class="col-lg-2 control-label">Konfirmasi Password</label>
									<div class="col-lg-10">
										<input type="password" class="form-control" name="konfirmasipassword" required="required" id="konfirmasi">
...
<script>
	$( "#konfirmasi" ).keyup(function( event ) {
	  if($( "#User_password").val() != $( "#konfirmasi").val()){
		$( "#s").text('Belum Sama');
	  }else{
		$( "#s").text('');
	  }
