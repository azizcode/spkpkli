	...
	<body>
		...
		<div id="wrapper">
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<li class="dropdown sidebar"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-table"></i>Laporan<b class="caret"></b></a>
					<ul>
                    	<li class="t"><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/rekomendasi">Mahasiswa</a></li>
                        <li class="t"><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/rekomendasi">Instansi</a></li>
                    </ul>
				</li>
				<li class="dropdown sidebar"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-table"></i>Kelola Sistem<b class="caret"></b></a>
					<ul>
                    	<li class="t"><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/datamahasiswa">Mahasiswa</a></li>
                        <li class="t"><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/datainstansi">Instansi</a></li>
						<li class="t"><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/pengumuman">Pengumuman</a></li>
                    </ul>
				</li>
