					...
					<div class="panel-body">
						...
						<form class="stdform" action="forms.html" method="post">
								...
								<div class="form-group">
								  ...
								  <div class="form-group">
									<label>2. Seberapa besar minat anda dalam bidang Sistem Informasi.?</label>
										<div>
											<label class="radio-inline">
												<input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="option1" checked=""> 1
											</label>
								  ...
								  <div class="form-group">
									<label>6. Apakah nilai matakuliah anda mempresentasikan kemampuan anda.?</label>
										<div>
											<label class="radio-inline">
												<input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="option1" checked=""> Ya
											</label>
											<label class="radio-inline">
												<input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="option1" checked=""> Tidak
											</label>
										</div>
								  </div>
								  <div class="form-group">
